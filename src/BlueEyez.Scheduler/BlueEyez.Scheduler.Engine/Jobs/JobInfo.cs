...
namespace BlueEyez.Scheduler.Engine.Jobs
{
    public class JobInfo
    {
            ...
            string logger = null)
        {
            var jobInfo = new JobInfo
            {
                ...
                Name = name,
                Description = desc,
                DescriptionSpecified = isDescSpecified,
                Schedule = schedule,
                ScheduleSpecified = isScheduleSpecified,
                ScheduleExpression = scheduleExp,
                ActionState = actionState,
                State = state,
                StateSpecified = isStateSpecified,
                NextFireTimeUtc = nextFire,
                NextFireTimeSpecified = isNextFireTimeSpecified,
                PrevFireTimeUtc = prevFire,
                PrevFireTimeSpecified = isPrevFireTimeSpecified,
                LoggerKey = logger
            };
